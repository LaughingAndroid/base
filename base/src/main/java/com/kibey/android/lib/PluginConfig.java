...
public class PluginConfig {
    ...
    public static final String KEY_PLUGIN ="pluginName";
    public static final String PAGE ="classTag";
    public static final String ROOT_CLASS_NAME ="root_class";
    public static final String ACTIVITY_URL="echoplugin://kibey.com/find_class";
