...
public class DialogUtils {
    ...
    public static IDialogDismiss show(Activity activity, String content, int type, OnDismissListener listener, boolean dialogFragment) {
        if (null != activity) {
            String title = "Notice";
    ...
    public static class ActionDialogFragment extends DialogFragment implements IDialogDismiss {
        ...
        public static ActionDialogFragment show(FragmentActivity activity, int type, String title, String content, OnDismissListener onDismissListener) {
